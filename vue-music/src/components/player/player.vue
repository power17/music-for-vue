  ...
  export default {
    ...
    methods: {
      ...
      middleTouchMove(e) {
        ...
        this.$refs.lyricList.$el.style.webkitTransition = 0
        this.$refs.middleL.style.opacity = 1 - this.touch.percent
        this.$refs.middleL.style.transition = 0
        this.$refs.middleL.style.webkitTransition = 0
      },
      middleTouchEnd(e) {
        let offsetWidth
        let opacity
        ...
        this.$refs.lyricList.$el.style.webkitTransition = `${time}ms`
        // 透明度
        this.$refs.middleL.style.opacity = opacity
        this.$refs.middleL.style.transition = 0
        this.$refs.middleL.style.webkitTransition = `${time}ms`
      },
      _pad(num, n = 2) {
